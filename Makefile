...
e2e-image: docker-pull-prerequisites
	docker build -f Dockerfile --tag="quay.io/dongsupark/capa-manager:e2e" .
	docker build -f Dockerfile --tag="quay.io/dongsupark/capa-eks-bootstrap-manager:e2e" --build-arg package=./bootstrap/eks  .
	docker build -f Dockerfile --tag="quay.io/dongsupark/capa-eks-controlplane-manager:e2e" --build-arg package=./controlplane/eks  .
